...
export async function applyCarrierBookingRequestAction(
  ...
  const { data: bookingId, error } = await supabase.rpc("accept_booking_request_atomic", {
    ...
    p_customer_mover_preference: bookingInput.customerMoverPreference,
    p_stairs_level_pickup: bookingInput.stairsLevelPickup,
    p_stairs_level_dropoff: bookingInput.stairsLevelDropoff,
    p_lift_available_pickup: bookingInput.liftAvailablePickup,
    p_lift_available_dropoff: bookingInput.liftAvailableDropoff,
