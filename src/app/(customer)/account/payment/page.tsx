  ...
  return (
    <main>
      ...
      <section className="screen space-y-3">
        ...
        <button
          type="button"
          className="flex min-h-[52px] min-w-[44px] w-full items-center justify-center rounded-md bg-[var(--bg-elevated-2)] text-[15px] text-text hover:bg-[var(--bg-elevated-3)] active:bg-[var(--bg-elevated-3)]"
        >
          Add payment method
        </button>
      </section>
