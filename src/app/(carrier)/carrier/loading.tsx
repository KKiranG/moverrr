export default function CarrierHomeLoading() {
  return (
    <main id="main-content" className="screen animate-pulse">
      <div className="mb-6">
        <div className="mb-2 h-3 w-24 rounded bg-black/[0.08] dark:bg-white/[0.12]" />
        <div className="mb-2 h-7 w-48 rounded bg-black/[0.08] dark:bg-white/[0.12]" />
        <div className="h-4 w-64 rounded bg-black/[0.08] dark:bg-white/[0.12]" />
      </div>
